...
const Footer = () => {
  ...
  return (
    <footer
      ...
      <div className="w-full flex-col flex lg:flex-row justify-between items-center mx-auto py-10 relative">
        ...
        <NavLink className="order-first lg:order-none my-4 sm:my-0 " to="/home">
          <img
            loading="lazy"
            src={Logo}
            alt=""
